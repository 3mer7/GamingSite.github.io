...
<body>
  ...
  <header>
    ...
    <div class="nav container">
		<div class="nav container">
			<div class="logo">
				...
				<a href="../html/index.html" class="logo">Ethio<span>Games</span></a>
			</div>
		<div class="nav-icons">
			...
			<div class="menu">
				...
				<div class="navbar">
					...
					<li><a href="item.html">Gears</a></li>
				</div>
			</div>
	...
	<section class="home container" id="home">
		<img src="../img/hollow-knight.jpg" alt="">
		<div class="home-text">
			...
			<div class="trending-content swiper">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="box">
							<img src="../img/man_in_a_hood.jpg" alt="">
							<div class="box-text">
								<h2>Whisper Blade</h2>
								<h3>Action</h3>
					...
					<div class="swiper-slide">
						<div class="box">
							<img src="../img/cyber predator.jpg" alt="">
							<div class="box-text">
            ...
            <div class="container flex">
                <form action="submit" class="flex">
                    ...
                    <select name="name" id="">
                        ...
                        <option value="Microsoft Windows">Windows</option>
	...
	<section class="new container" id="new">
		...
		<div class="new-content">
			<!--box 1-->
			<div class="box">
				<img src="../img/gate-samurai.jpg" alt="">
				<div class="box-text">
					<h2>Whisper Blade</h2>
					<h3>Action</h3>
					<div class="rating-download">
			...
			<!--box 4-->
			<div class="box">
				<img src="../img/5361782.jpg" alt="">
				<div class="box-text">
					<h2>Cosmic Courier</h2>
					<h3>Action</h3>
					<div class="rating-download">
						<div class="rating">
							<i class='bx bxs-star'></i>
			...
			<!--box 9-->
			<div class="box">
				<img src="../img/masterpiece.jpg" alt="">
				<div class="box-text">
					<h2>Crimson Moon</h2>
					<h3>Action</h3>
					<div class="rating-download">
