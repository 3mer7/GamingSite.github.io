...
<body>
    ...
    <div class="container">
        ...
        <section class="userProfile card">
            <div class="profile">
                <figure><img src="../images/dazai.jpg" alt="profile" width="250px" height="250px"></figure>
            </div>
        </section>
        ...
        <section class="work_skills card">
            ...
            <div class="work">
                ...
                <div class="primary">
                    <h1>Star Of All Hunter</h1>
                    <span>details</span>
                    <p>Total time played 540 <br> last played 23 hours ago</p>
                </div>

                <div class="secondary">
                    <h1>Genshin impact </h1>
                    <span>details</span>
                    <p>Total time played 170hr <br> last played in 30 days ago</p>
                </div>
            </div>
            ...
            <div class="skills">
                ...
                <ul>
                    <li style="--i:0">Game Finished</li>
                    <li style="--i:1">IN Progress</li>
                    <li style="--i:2"></li>
                    <li style="--i:3">Mac</li>
                </ul>
            </div>
